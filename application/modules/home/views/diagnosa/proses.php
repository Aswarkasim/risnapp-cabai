    ...
    <div class="container">
        ...
        <div class="offset-md-3 col-md-6">
            ...
            <div class="form-group">
                ...
                <strong class="text-danger"><?= $jenis->nama_jenis; ?></strong>
            </div>
            <hr>
            <div class="form-group">
                <label for=""><strong>PERSENTASE KEAKURATAN</strong></label><br>
                <span class="text-danger"><?= $konsultasi->akumulasi_cf . '%' ?></span>
            </div>
            <hr>

            <div class="form-group">
                <label for=""><strong>DESKRIPSI</strong></label><br>
                <span class=""><?= $jenis->deskripsi ?></span>
            </div>
            <hr>

            <div class="form-group">
                <label for=""><strong>PENANGANAN</strong></label><br>
                <span class=""><?= $jenis->penanganan ?></span>
            </div>
            <hr>
            ...
            <div class="form-group">
                ...
                <span class="">
                    <img src="<?= base_url($jenis->gambar); ?>" width="300px" alt="">
                </span>
            </div>
            <hr>
